...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 z-50 w-64 bg-white border-r-2 border-pink-300 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen lg:shrink-0 flex flex-col justify-between overflow-y-auto ${
