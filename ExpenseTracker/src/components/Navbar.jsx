...
export const Navbar = ({ onToggleSidebar, onOpenAddModal, onOpenTour, onOpenExport, title = 'Dashboard' }) => {
  return (
    <header className="sticky top-0 z-30 h-18 bg-white/95 backdrop-blur-md border-b-2 border-pink-300 px-4 lg:px-8 flex items-center justify-between transition-colors">
